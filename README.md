...
├── src/
│   └── preprocessing/
│       └── helpers.py                   ← Custom sklearn transformers (pipeline steps)
│
├── data/
│   ├── data.csv                         ← Raw dataset (download from UCI)
│   ├── X_train.csv                      ← Preprocessed training features (generated)
│   ├── X_test.csv                       ← Preprocessed test features (generated)
│   ├── y_train.csv                      ← Training labels (generated)
│   └── y_test.csv                       ← Test labels (generated)
│
...
| `src/preprocessing/helpers.py` | Custom sklearn transformers used in the preprocessing pipeline |
| `data/data.csv` | Raw UCI dataset (not committed — download from link above) |
| `data/X_train.csv`, `X_test.csv` | Preprocessed feature matrices (generated by notebook Part 2) |
